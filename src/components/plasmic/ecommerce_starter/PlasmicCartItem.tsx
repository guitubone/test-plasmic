...
import * as sty from "./PlasmicCartItem.module.css"; // plasmic-import: oINsZBLAF-C7/css
              ...
              defaultContents: (
                <React.Fragment>
                  ...
                  <p.Stack
                    as={"div"}
                    hasGap={true}
                    className={classNames(defaultcss.all, sty.freeBox__jBi8)}
                  >
                    <Icon31Icon
                      className={classNames(defaultcss.all, sty.svg__cTRxy)}
                      role={"img"}
                    />

                    <Icon30Icon
                      className={classNames(defaultcss.all, sty.svg__safoz)}
                      role={"img"}
                    />
                  </p.Stack>
                </React.Fragment>
